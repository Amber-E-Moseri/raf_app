...
function defaultAllocationCategories(householdId) {
  return [
    { id: uuid(), householdId, slug: 'savings', label: 'Savings', sortOrder: 1, allocationPercent: '0.1000', isSystem: true, isActive: true },
    { id: uuid(), householdId, slug: 'fixed_bills', label: 'Fixed Bills', sortOrder: 2, allocationPercent: '0.3000', isSystem: true, isActive: true },
    { id: uuid(), householdId, slug: 'personal_spending', label: 'Personal Spending', sortOrder: 3, allocationPercent: '0.1500', isSystem: true, isActive: true },
    { id: uuid(), householdId, slug: 'investment', label: 'Investment', sortOrder: 4, allocationPercent: '0.1000', isSystem: false, isActive: true },
    { id: uuid(), householdId, slug: 'debt_payoff', label: 'Debt Payoff', sortOrder: 5, allocationPercent: '0.1000', isSystem: false, isActive: true },
    { id: uuid(), householdId, slug: 'buffer', label: 'Buffer', sortOrder: 9, allocationPercent: '0.2500', isSystem: true, isActive: true },
  ].map((row) => ({
    ...row,
    createdAt: isoNow(),
    updatedAt: isoNow(),
