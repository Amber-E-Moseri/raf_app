...
/**
 * @typedef {Object} TrajectoryProjectionInput
 * @property {string} activeMonth
 * @property {number} months
 * @property {{monthlyEssentialsBaseline?: string, monthly_essentials_baseline?: string}} household
 * @property {Array<Object>} debts
 * @property {Array<{debtId: string, paymentDate: string, amount: string}>} debtPayments
 * @property {Array<{receivedDate: string, amount: string}>} incomeEntries
 * @property {Array<{transactionDate: string, direction: 'debit'|'credit', amount: string}>} transactions
 * @property {Array<{slug?: string, allocatedAmount?: string, amount?: string}>} incomeAllocations
 * @property {Array<{slug: string, allocationPercent: string, isActive?: boolean, sortOrder?: number}>} allocationCategories
 * @property {Array<{distributions?: {emergency_fund?: string}}>} monthlyReviews
 * @property {Array<{slug: string, splitPercent: string, isActive?: boolean, sortOrder?: number}>} surplusSplitRules
 */
