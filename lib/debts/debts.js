...
const adjustmentTypeSchema = z.enum(['manual', 'correction', 'interest', 'fee', 'late_fee', 'reconciliation']);
...
export const updateDebtSchema = z
  ...
  .superRefine((value, context) => {
    ...
    const editableKeys = ['name', 'apr', 'minimumPayment', 'monthlyPayment', 'statementDay', 'paymentDueDay', 'lateFeeAmount', 'autoPostInterest', 'autoPostLateFee', 'sortOrder', 'isActive'];
